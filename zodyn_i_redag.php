            ...
            <table class="center"><tr><td>
						...
						<?php
							...
							if(isset($_POST['submit']) || isset($_POST['submit1'])){
								...
								header("Location: zodyn_i_redag.php");
							...
							//echo $vartot;
							$query="SELECT * from zodynas_italu";
							...
							echo "<table border=\"1\" class='table table-dark'>";
								...
								{while($row=mysqli_fetch_assoc($result))
									{
									echo "<tr><td>".$row['zodis']."</td><td>".$row['vertimas']."</td><td>".$row['tematika']."</td><td>"."<a href='zodyn_i_redag.php?fn=delete&id=".$row['id']."' >Trinti</a>"."</td><td>"."<a href='zodyn_i_redag.php?fn=edit&id=".$row['id']."' >Redaguoti</a>"."</td></tr>";
									}
								};
								echo "</table><br><br>";
							echo"<form method='post'>
							...
							if($zodis != null && $vertimas != null && $_POST['submit']){
								$sql="INSERT INTO zodynas_italu(zodis, vertimas, tematika) VALUES ('$zodis','$vertimas','$tematika')";
							...
							if ($_GET['fn'] == "delete")
     							if (!empty($_GET['id'])){
            						$id=$_GET['id'];
									echo $id;
									$sql="DELETE from zodynas_italu WHERE id='$id'";
									mysqli_query($dbc, $sql);
									for ($i=0; $i<1; $i++)
										header("Location:zodyn_i_redag.php");
									$reload=1;
							...
							if ($_GET['fn'] == "edit")
     							if (!empty($_GET['id'])){
									...
									$id1=$id;
									$redag=true;
									$sql1="SELECT zodis,vertimas,tematika from zodynas_italu WHERE id='$id'";
							...
							if ($redag)
							{
								...
								if($_POST['keiciamozodis']!=null && $_POST['keiciamovertimas'] && $_POST['keiciamotema']==null){
									$sql2="UPDATE zodynas_italu SET vertimas='$vertim' WHERE id='$id1'";
									$sql3="UPDATE zodynas_italu SET zodis='$zod' WHERE id='$id1'";
								...
								} else if($_POST['keiciamozodis']!=null && $_POST['keiciamovertimas'] && $_POST['keiciamotema']!=null)
								{
									$sql2="UPDATE zodynas_italu SET vertimas='$vertim' WHERE id='$id1'";
									$sql3="UPDATE zodynas_italu SET zodis='$zod' WHERE id='$id1'";
									$sql4="UPDATE zodynas_italu SET tematika='$tema' WHERE id='$id1'";
									mysqli_query($dbc, $sql2);
									mysqli_query($dbc, $sql3);
