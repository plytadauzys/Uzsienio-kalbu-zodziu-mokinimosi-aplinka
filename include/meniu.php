...
if (isset($session) && $session->logged_in) {
    ...
    <table width=100% border="0" cellspacing="1" cellpadding="3" class="meniu">
        ...
        echo "<a href=\"" . $path . "anglu.php\">Anglų žodynas</a> &nbsp;&nbsp;"
        . "<a href=\"" . $path . "italu.php\">Italų žodynas</a> &nbsp;&nbsp;";
		if($session->isManager() || $session->isAdmin()){
		} else{
			echo "<a href=\"" . $path . "spec.php\">Specifinis žodynas</a> &nbsp;&nbsp;"
			."<a href=\"" . $path . "raportas.php\">Raportas</a> &nbsp;&nbsp;";
		}
        //Trečia operacija rodoma valdytojui ir administratoriui
        if ($session->isManager()) {
            echo "<a href=\"" . $path . "zodyn.php\">Žodynų redagavimas</a> &nbsp;&nbsp;";
        }
